...
### 🔥 **Part 2** in-database Machine Learning Tasks
1. Machine Learning Over Static and Dynamic Relational Data (DEBS 2021, Tutorial) [[PDF](https://dl.acm.org/doi/pdf/10.1145/3465480.3467843)]
2. The Relational Data Borg is Learning (VLDB 2020, Tutorial) [[PDF](https://arxiv.org/pdf/2008.07864.pdf)]
3. Learning Models over Relational Data: A Brief Tutorial (SUM 2019, Tutorial) [[PDF](https://arxiv.org/pdf/2008.07864.pdf)]
4. Data Management in Machine Learning: Challenges, Techniques, and Systems (SIGMOD 2017) [[PDF](https://dl.acm.org/doi/pdf/10.1145/3035918.3054775)]
5. Data Management Challenges in Production Machine Learning (SIGMOD 2017) [[PDF](https://dl.acm.org/doi/pdf/10.1145/3035918.3054782)]
6. F-IVM: learning over fast-evolving relational data (SIGMOD 2020) [[PDF](https://dl.acm.org/doi/pdf/10.1145/3318464.3384702)]
7. Incremental Maintenance of Regression Models over Joins (ArXiv 2017) [[PDF](http://www.cs.ox.ac.uk/dan.olteanu/papers/no-pvldb17.pdf)]
8. Incremental View Maintenance with Triple Lock Factorization Benefits (SIGMOD 2018) [[PDF](https://dl.acm.org/doi/pdf/10.1145/3183713.3183758)]
9. Liveview: Incremental View Maintenance for Complex Analytical Queries (SIGMOD 2014) [[PDF](https://dl.acm.org/doi/pdf/10.1145/2588555.2610519)]

### **Part 3** Traditional Machine Learning (e.g., Decision Tree, SVM)
...
### **Part 4** Deep Learning (e.g., DNNs)
#### **Part 4.1** w/ Incremental Computation
...
### **Part 5** Tools or Implementations
